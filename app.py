...
import openai
from processing import get_index_for_pdf, get_api_key
...
# get and set openai key
api_key = get_api_key('key.txt')
os.environ["OPENAI_API_KEY"] = api_key
openai.api_key = api_key

# function to create a vectordb for provided PDF files
@st.cache_data
...
# Upload PDF files with Streamlit
...
if question:
    ...
    # change model to GPT-4 as needed
    response = []
    result = ""
